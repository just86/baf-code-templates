...
200;300;400
1cПараметры = ПараметрыЧтенияCSV();
Параметры.ПутьКФайлу = "C:\numbers.csv";
Параметры.ПервыйРядокЗаголовок = Ложь;
...
1cПараметры = ПараметрыЧтенияCSV();
Параметры.ПутьКФайлу = "C:\data_comma.csv";
Параметры.Разделитель = ",";
Параметры.Кодировка = КодировкаТекста.UTF8;
