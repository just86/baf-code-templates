...
ПараметрыЦСВ.ПутьКФайлу = "C:\data.csv";
ПараметрыЦСВ.ПервыйРядокЗаголовок = Истина;
ПараметрыЦСВ.ИспользоватьАвтоименаКолонок = Истина; // Ігноруємо заголовки
...
Функция ПараметрыЧтенияCSV() Экспорт
	...
	ПараметрыЦСВ = Новый Структура;
	ПараметрыЦСВ.Вставить("ПутьКФайлу", "");
	ПараметрыЦСВ.Вставить("ПервыйРядокЗаголовок", Истина);
	ПараметрыЦСВ.Вставить("Разделитель", ";");
	ПараметрыЦСВ.Вставить("Кодировка", КодировкаТекста.UTF8);
	ПараметрыЦСВ.Вставить("ИспользоватьАвтоименаКолонок", Ложь);
	
	Возврат ПараметрыЦСВ;
